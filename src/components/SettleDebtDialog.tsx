                            ...
                            return (
                                <div key={debt.toId} className="p-4 bg-muted/40 rounded-2xl border border-border/50">
                                    ...
                                    <div className="flex gap-2 mt-2">
                                        ...
                                        <Button
                                            variant={upiLink ? "outline" : "default"}
                                            className={`flex-1 rounded-xl font-bold ${!upiLink ? 'w-full shadow-lg shadow-primary/20' : 'border-primary/20 text-primary hover:bg-primary/5'}`}
